...
def split_files(file_text, func_search):
    ...
    new_file = f"glabel func_{func_search[1:-1]}" + "\n" + chunk
...
def main():
    ...
    print(f"Splicing new pragma statement into {ps_path}")
